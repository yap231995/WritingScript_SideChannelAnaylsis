...
class Oscilloscope():
    ...
    def getWaveform_16_2(self):
        # self.xlApp.WriteString("WAIT", True)

        return numpy.array(self.xlApp.GetIntegerWaveform("C2", self.Samples, 0), numpy.uint16)

    def getWaveform_16_3(self):
        # self.xlApp.WriteString("WAIT", True)

        return numpy.array(self.xlApp.GetIntegerWaveform("C3", self.Samples, 0), numpy.uint16)

    def getWaveform_16_4(self):
        # self.xlApp.WriteString("WAIT", True)

        return numpy.array(self.xlApp.GetIntegerWaveform("C4", self.Samples, 0), numpy.uint16)

    def getWaveform_16_1(self):
        # self.xlApp.WriteString("WAIT", True)

        return numpy.array(self.xlApp.GetIntegerWaveform("C1", self.Samples, 0), numpy.uint16)

    def getWaveform_8_2(self):
        return numpy.frombuffer(self.xlApp.GetByteWaveform("C2", self.Samples, 0), numpy.uint8)

    def getWaveform_8_3(self):
        return numpy.frombuffer(self.xlApp.GetByteWaveform("C3", self.Samples, 0), numpy.uint8)

    def getWaveform_8_4(self):
        return numpy.frombuffer(self.xlApp.GetByteWaveform("C4", self.Samples, 0), numpy.uint8)

    def getWaveform_8_1(self):
